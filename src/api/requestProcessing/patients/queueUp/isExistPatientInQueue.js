...
const isExistInQueue = async (patientID, queueID) => !await queue.addPatient(patientID, queueID);

export default async ({ data: { patientID, specializationID: queueID } }, res, next) => {
  try {
